...
class Agent:
    def __init__(self, num_actions, state_size):
        ...
        hidden_layer_3 = tf.layers.dense(hidden_layer_2, 16, activation=tf.nn.relu, kernel_initializer=initializer)
        hidden_layer_4 = tf.layers.dense(hidden_layer_3, 16, activation=tf.nn.relu, kernel_initializer=initializer)
